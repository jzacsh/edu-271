...
public class SwingWorkerDemo extends JApplet {
  ...
  public SwingWorkerDemo() {
    ...
    panel2.setBorder(BorderFactory
        .createTitledBorder("Without Using SwingWorker"));
    ...
    jbtComputeWithSwingWorker.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        new ComputePrime(Integer.parseInt(jtfLimit1.getText()), jtfResult1)
            .execute(); // Execute SwingWorker
      }
    });

    jbtCompute.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        int count = ComputePrime.getNumberOfPrimes(Integer.parseInt(jtfLimit2
            .getText()));
